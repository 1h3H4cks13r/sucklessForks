...
static const double defaultopacity  = 0.8;	/* clientopacity default value */
...
//Userdefined Alt key for using in the keybinds. Directly having Mod1Mask won't work
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_Return, zoom,           {0} },
				//vanitygaps keybinds start Mod1Mask=AltKey
...
// 	 { MODKEY,                       XK_space,  setlayout,      {0} },
	...
	{ MODKEY|ShiftMask,		XK_r,      quit,           {1} }, //Reload DWM-Using restartsig patch
};
